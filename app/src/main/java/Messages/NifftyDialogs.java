...
public class NifftyDialogs {
    ...
    public  void justMessage(String txt){
        ...
        dialogBuilder
                ...
                .withDialogColor( Build.VERSION.SDK_INT>21? ContextCompat.getColor(context, R
                        .color.colorPrimary): context.getResources().getColor(R.color.colorPrimary))
                .withMessage(txt)
                .show();
    }
    public void  messageOk(String Title,String message){
        ...
        dialogBuilder.withTitle("")
                .withDialogColor(Build.VERSION.SDK_INT>21? ContextCompat.getColor(context, R.color.colorPrimaryDark): context.getResources().getColor(R.color.colorPrimaryDark))
                .withTitleColor("#FFFFFF")
                .withMessage(message)
                .withButton1Text("Ok").isCancelableOnTouchOutside(false).withEffect(stylepop_up())
                .withIcon(R.drawable.ic_menu_manage).withDuration(700)
